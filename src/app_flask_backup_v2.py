"""
MediaBrowser Flask Application
==============================
Shared Flask application for the MediaBrowser suite.
Contains all routes for search, archive, cart, and production interfaces.

This module can be imported by:
- mediabrowser.py (standalone CLI launcher)
- launchpad.py (GUI launcher with buttons)
- projectbrowser.py (project-specific extensions)
...
from flask import Flask, render_template, request, url_for, abort, session, redirect, send_file, jsonify, flash, send_from_directory
